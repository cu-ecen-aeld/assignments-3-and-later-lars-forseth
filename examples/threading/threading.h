...
* The thread started should return a pointer to the thread_data structure when it exits,
* which can be used to free memory as well as to check thread_complete_success for successful exit.
